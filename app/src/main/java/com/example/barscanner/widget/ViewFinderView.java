package com.example.barscanner.widget;
...
import com.example.barscanner.utils.DisplayUtils;
...
public class ViewFinderView extends View implements IViewFinder {
    ...
    private static final int PORTRAIT_MAX_FRAME_HEIGHT = (int) (1920 * PORTRAIT_HEIGHT_RATIO); // = 6/8 * 1920
